...
public class Slot_Tooltip : MonoBehaviour
{
    [SerializeField]
    ...
    public void ShowToolTip(Item _item, Vector3 _pos)
    {
        ...
        _pos += new Vector3(go_Base.GetComponent<RectTransform>().rect.width * 0.7f, -go_Base.GetComponent<RectTransform>().rect.height, 0f);
